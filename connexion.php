    ...
    <main>
        ...
        <form method="post" action='#'>
            <fieldset>
                ...
                Nom d'utilisateur :
                <input type="text" name="login" required="required" <?php if (isset($errors['login'])) echo 'class="errorField"' ?> value="<?php echo ($postedValues['login']) ?>" />*<br />

                Mot de passe :
                <input type="password" name="password" required="required" <?php if (isset($errors['password'])) echo 'class="errorField"' ?> value="<?php echo ($postedValues['password']) ?>" />*<br />
                ...
                <?php if ($isInscription) : ?>
                    ...
                    Nom :
                    <input type="text" name="name" <?php if (isset($errors['name'])) echo 'class="errorField"' ?> value="<?php echo ($postedValues['name']) ?>" /><br />


                    Prénom :
                    <input type="text" name="fname" <?php if (isset($errors['fname'])) echo 'class="errorField"' ?> value="<?php echo ($postedValues['fname']) ?>" /><br />
                    ...
                    Adresse postale <br />
                    <input type="text" name="address" placeholder='adresse' <?php if (isset($errors['address'])) echo 'class="errorField"' ?> value="<?php echo ($postedValues['address']) ?>" /><br />
                    <input type="text" name="postcode" placeholder='code postal' <?php if (isset($errors['postcode'])) echo 'class="errorField"' ?> value="<?php echo ($postedValues['postcode']) ?>" /><br />
